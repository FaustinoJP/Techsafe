    ...
    <div className="relative">
      ...
      <div className="relative bg-white/80 backdrop-blur-sm border border-green-100/50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-500">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#ff0000] to-[#ff0000] rounded-2xl mb-4 shadow-lg">
          ...
          <div className="w-16 h-1 bg-gradient-to-r from-[#ff0000] to-[#ff0000] rounded-full mx-auto"></div>
        </div>

        <div className="space-y-6">
          {/* Email */}
          <div className="group relative">
            <div className="absolute inset-0 bg-gradient-to-r from-[#ff0000]/5 to-transparent rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            <div className="relative flex items-center p-4 rounded-xl border border-transparent group-hover:border-[#ff0000]/20 transition-all duration-300">
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-[#ff0000]/10 to-[#ff0000]/5 rounded-xl flex items-center justify-center group-hover:from-[#ff0000]/20 group-hover:to-[#ff0000]/10 transition-all duration-300">
                  <Mail className="h-6 w-6 text-[#ff0000]" />
                </div>
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-[#ff0000] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <div className="ml-4 flex-1">
                ...
                <a
                  ...
                  className="text-gray-600 hover:text-[#ff0000] transition-colors duration-300 font-medium"
                >
          ...
          <div className="group relative">
            ...
            <div className="relative flex items-center p-4 rounded-xl border border-transparent group-hover:border-[#ff0000]/20 transition-all duration-300">
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-[#ff0000]/10 to-[#ff0000]/5 rounded-xl flex items-center justify-center group-hover:from-[#ff0000]/20 group-hover:to-[#ff0000]/10 transition-all duration-300">
                  <Phone className="h-6 w-6 text-[#ff0000]" />
                </div>
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-[#ff0000] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <div className="ml-4 flex-1">
          ...
          <div className="relative mt-8">
            <div className="absolute inset-0 bg-gradient-to-br from-[#ff0000]/5 to-green-50/50 rounded-xl"></div>
            <div className="relative p-6 rounded-xl border border-[#ff0000]/10">
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 bg-gradient-to-br from-[#ff0000] to-[#ff0000] rounded-lg flex items-center justify-center shadow-md">
