  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="group relative bg-white shadow-xl sticky top-0 z-50 transition-all duration-500">
        ...
        {/* Decorative Line */}
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#ff9700] to-transparent opacity-60"></div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              {[
                ...
                <Link
                  key={item.href}
                  href={item.href}
                  className="group/link relative text-gray-700  transition-all duration-300 font-semibold px-4 py-2 rounded-lg hover:bg-[#ff9700]/5"
                >
                  {item.label}
                  {/* Enhanced underline effect */}
                  <span className="absolute -bottom-1 left-4 right-4 h-0.5 bg-gradient-to-r from-[#ff9700] to-[#9a0436cd] scale-x-0 group-hover/link:scale-x-100 transition-transform duration-300 origin-left"></span>
                  {/* Hover glow */}
            ...
            <div className="md:hidden flex items-center space-x-2">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-[#ff9700]/20 to-[#9a0436cd]/20 rounded-lg opacity-0 group-hover/mobile:opacity-100 transition-opacity duration-300"></div>
                {mobileMenuOpen ? (
                  <X className="h-6 w-6 text-[#ff9700] relative z-10" />
                ) : (
                  <Menu className="h-6 w-6 text-[#ff9700] relative z-10" />
                )}
              </Button>
            </div>
          </div>
              ...
              <nav className="flex flex-col space-y-2">
                {[
                  ...
                  <Link
                    key={item.href}
                    href={item.href}
                    className="group/mobile-link relative text-gray-700 hover:text-[#ff9700] transition-all duration-300 font-semibold px-4 py-3 rounded-lg hover:bg-[#ff9700]/10 flex items-center justify-between"
                  ...
                  >
                    ...
                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-[#ff9700] to-[#9a0436cd] scale-y-0 group-hover/mobile-link:scale-y-100 transition-transform duration-300 origin-top rounded-r-full"></div>
                  </Link>
                ))}
              </nav>
            </div>
      ...
      >
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-[#ff9700]/5 to-transparent rounded-full transform translate-x-32 -translate-y-32"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-[#ff9700]/3 to-transparent rounded-full transform -translate-x-48 translate-y-48"></div>
          ...
          <div className="text-center mb-16">
            <div className="inline-block">
              <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent mb-4 relative">
                {t.servicesTitle}
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-gradient-to-r from-[#ff9700] to-[#9a0436cd] rounded-full"></div>
              </h2>
            </div>
      ...
      <section id="about" className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-20 left-10 w-32 h-32 border-2 border-[#ff9700] rounded-full"></div>
          <div className="absolute top-40 right-20 w-24 h-24 bg-[#ff9700] rounded-full"></div>
          <div className="absolute bottom-20 left-1/4 w-16 h-16 border-2 border-[#ff9700] rotate-45"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="group relative bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-xl p-8 mb-16 overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#ff9700]/10 to-transparent rounded-2xl transform rotate-45 translate-x-16 -translate-y-16 group-hover:from-[#ff9700]/20 transition-all duration-500"></div>
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {missionPoints.map((point, index) => (
                  ...
                  >
                    <div className="relative">
                      <div className="w-10 h-10 bg-gradient-to-br from-[#ff9700] to-[#9a0436cd] rounded-full flex items-center justify-center flex-shrink-0 group-hover/item:scale-110 transition-all duration-300 shadow-lg">
                        <CheckCircle className="h-5 w-5 text-white" />
                      </div>
                      <div className="absolute inset-0 bg-gradient-to-br from-[#ff9700] to-[#9a0436cd] rounded-full blur-lg opacity-0 group-hover/item:opacity-30 transition-opacity duration-500 -z-10"></div>
                    </div>
      ...
      >
        {/* Background decorative elements */}
        <div className="absolute top-0 left-0 w-64 h-64 bg-gradient-to-br from-[#ff9700]/5 to-transparent rounded-full transform -translate-x-32 -translate-y-32"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-[#ff9700]/3 to-transparent rounded-full transform translate-x-48 translate-y-48"></div>
      ...
      <footer className="group relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-16 overflow-hidden">
        {/* Background Effects */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#ff9700]/5 via-transparent to-[#007a4e]/5 opacity-50"></div>
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#ff9700] to-transparent"></div>

        {/* Decorative Elements */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-[#ff9700]/10 to-transparent rounded-full transform translate-x-32 -translate-y-32 group-hover:scale-110 transition-transform duration-1000"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-[#ff9700]/5 to-transparent rounded-full transform -translate-x-48 translate-y-48 group-hover:scale-110 transition-transform duration-1000"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="group/footer-logo">
              <div className="relative mb-6">
                <div className="absolute inset-0 bg-gradient-to-br from-[#ff9700] to-[#9a0436cd] rounded-xl blur-lg opacity-0 group-hover/footer-logo:opacity-30 transition-all duration-500 scale-110"></div>
                {/* <div className="relative bg-gradient-to-br from-[#ff9700] to-[#007a4e] p-3 rounded-xl inline-block group-hover/footer-logo:scale-105 transition-all duration-300"> */}
                <Image
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  <a
                    key={social.label}
                    href="#"
                    className="group/social relative w-12 h-12 bg-gradient-to-br from-[#ff9700] to-[#9a0436cd] rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg"
                    style={{ animationDelay: `${index * 100}ms` }}
                  >
                    <social.icon className="h-5 w-5 text-white relative z-10" />
                    <div className="absolute inset-0 bg-gradient-to-br from-[#ff9700] to-[#9a0436cd] rounded-full blur-lg opacity-0 group-hover/social:opacity-50 transition-opacity duration-500 scale-110"></div>
                    <div className="absolute inset-0 border-2 border-[#ff9700]/30 rounded-full scale-110 opacity-0 group-hover/social:opacity-100 group-hover/social:scale-125 transition-all duration-500"></div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="group/service-item">
                    ...
                    >
                      <ChevronRight className="h-4 w-4 mr-2 opacity-0 group-hover/service-item:opacity-100 transition-all duration-300 text-[#ff9700]" />
                      <span className="relative">
                        {service}
                        <span className="absolute bottom-0 left-0 w-0 h-px bg-gradient-to-r from-[#ff9700] to-[#ff9700] group-hover/service-item:w-full transition-all duration-300"></span>
                      </span>
                    </a>
                  </li>
                ))}
              ...
              <div className="space-y-4">
                {[
                  ...
                  <a
                    key={index}
                    href={contact.href}
                    className="group/contact-item flex items-center gap-3 text-gray-300 hover:text-[#ff9700] transition-all duration-300 p-2 rounded-lg hover:bg-white/5"
                  >
                    <div className="relative">
                      <div className="w-10 h-10 bg-gradient-to-br from-[#ff9700]/20 to-[#ff9700]/20 rounded-lg flex items-center justify-center group-hover/contact-item:scale-110 transition-all duration-300">
                        <contact.icon className="h-5 w-5 text-[#ff9700]" />
                      </div>
                      <div className="absolute inset-0 bg-gradient-to-br from-[#ff9700] to-[#ff9700] rounded-lg opacity-0 group-hover/contact-item:opacity-20 transition-opacity duration-300"></div>
                    </div>
          ...
          <div className="relative">
            ...
            <div className="pt-8 text-center">
              <div className="inline-block group/copyright">
                ...
                <div className="w-0 h-px bg-gradient-to-r from-[#ff9700] to-[#ff9700] group-hover/copyright:w-full transition-all duration-500 mx-auto mt-2"></div>
              </div>
            </div>
          </div>
        </div>
