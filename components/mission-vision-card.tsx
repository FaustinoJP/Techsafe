      ...
      <div className="relative p-8 h-full flex flex-col">
        ...
        <div className="flex items-start gap-4 mb-6">
          <div className="relative">
            {/* Icon Container */}
            <div className="w-16 h-16 bg-gradient-to-br from-[#ff0000] to-[#ff0000] rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl group-hover:scale-110 transition-all duration-500">
          ...
          <div className="flex-1">
            <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent mb-2 group-hover:from-[#ff0000] group-hover:to-[#007a4e] transition-all duration-500">
              {title}
            </h3>
