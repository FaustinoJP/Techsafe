...
export function VideoSection({ locale }: VideoSectionProps) {
  ...
  const getTitle = () => {
    switch (locale) {
      case "pt":
        return "Conheça a Faustware Soluções";
      case "fr":
        return "Découvrez Faustware Solutions";
      case "it":
        return "Scopri Faustware Solutions";
      default:
        return "Discover Faustware Solutions";
    }
  };
    ...
    <section className="py-20 bg-gradient-to-br from-slate-50 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fillRule='evenodd'%3E%3Cg fill='%23ea1e63' fillOpacity='0.1'%3E%3Ccircle cx='30' cy='30' r='2'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
          }}
        />
      </div>

      {/* Decorative Elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-[#ea1e63]/10 to-transparent rounded-full transform translate-x-48 -translate-y-48"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-[#ea1e63] to-[#ea1e63] rounded-full mx-auto mb-6"></div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="group relative mb-16">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-[#ea1e63]/5 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="relative">
                      <Button
                        ...
                        size="lg"
                        className="bg-gradient-to-br from-[#ea1e63] to-[#ea1e63] hover:from-[#ea1e63] hover:to-[#ea1e62dd] text-white rounded-full w-20 h-20 flex items-center justify-center shadow-2xl transform group-hover:scale-110 transition-all duration-300 border-0"
                      >
                        {isPlaying ? (
                      ...
                      {/* Glow Effect */}
                      <div className="absolute inset-0 bg-gradient-to-br from-[#ea1e63] to-[#ea1e62dd] rounded-full blur-lg opacity-0 group-hover:opacity-40 transition-opacity duration-500 -z-10"></div>
                      {/* Pulse Ring */}
                      <div className="absolute inset-0 border-2 border-[#ea1e63]/30 rounded-full scale-110 opacity-0 group-hover:opacity-100 group-hover:scale-125 transition-all duration-500"></div>
                    </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-8">
                  <div className="flex items-center justify-between text-white">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-2xl font-bold text-[#ea1e63]">
                        2:30
                      </div>
                    </div>
                  </div>
            ...
            {/* Hover Border */}
            <div className="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-[#ea1e63]/20 transition-all duration-500"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group relative h-full">
                ...
                {/* Decorative Elements */}
                <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-[#ea1e63]/10 to-transparent rounded-2xl transform rotate-45 translate-x-12 -translate-y-12 group-hover:from-[#ea1e63]/20 transition-all duration-500"></div>
                ...
                <div className="relative p-8 h-full flex flex-col text-center">
                  ...
                  <div className="relative mb-6 mx-auto">
                    {/* Icon Container */}
                    <div className="w-20 h-20 bg-gradient-to-br from-[#ea1e63] to-[#ea1e62dd] rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl group-hover:scale-110 transition-all duration-500 mx-auto mb-4">
                    ...
                    {/* Number Badge */}
                    <div className="absolute -top-2 -right-2 bg-gradient-to-br from-[#00bcd5] to-[#00bcd5] text-white text-sm font-bold px-3 py-1 rounded-full shadow-lg">
                      {feature.number}
                    </div>
                  </div>

                  {/* Title */}
                  <h4 className="text-xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent mb-3 group-hover:from-[#ea1e63] group-hover:to-[#ea1e62dd] transition-all duration-500">
                    {feature.title[locale] || feature.title.en}
                  </h4>

                  {/* Divider */}
                  <div className="w-12 h-1 bg-gradient-to-r from-[#ea1e63] to-[#ea1e62dd] rounded-full mx-auto mb-4 group-hover:w-16 transition-all duration-500"></div>
                  ...
                  {/* Bottom Elements */}
                  <div className="mt-6 pt-4 border-t border-gray-100 group-hover:border-[#ea1e63]/20 transition-colors duration-300">
                ...
                {/* Hover Border */}
                <div className="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-[#ea1e63]/20 transition-all duration-500"></div>
              </div>
            ))}
          </div>
        </div>
