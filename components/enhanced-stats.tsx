...
export function ModernStats({ locale }: ModernStatsProps) {
  ...
  const stats: StatItem[] = [
    ...
    },
    {
      ...
      description:
        locale === "pt"
          ? "Soluções entregues com sucesso"
    ...
    },
    {
      ...
      description:
        locale === "pt"
          ...
          : "Long-lasting partnerships established",
    },
    {
      icon: Clock,
      value: "24/7",
      ...
      description:
        locale === "pt"
          ? "Assistência contínua disponível"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-purple-500 rounded-full blur-3xl animate-pulse"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        ></div>
        <div
          className="absolute top-3/4 right-1/4 w-6 h-6 bg-blue-500/20 rounded-full animate-bounce"
          style={{ animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute top-1/2 right-1/3 w-3 h-3 bg-purple-500/20 rotate-45 animate-bounce"
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-5xl font-bold text-gray-900 mb-3 group-hover:text-[#ff9700] transition-colors duration-300 relative">
                      ...
                      {stat.value.includes("%") && "%"}
                      {stat.value.includes("/") &&
                        stat.value.substring(stat.value.indexOf("/"))}
                    </div>
                    ...
                    {/* Decorative Line */}
                    <div
                      className={`w-16 h-1 bg-gradient-to-r ${stat.color} rounded-full mx-auto mt-6 group-hover:w-24 transition-all duration-500`}
                    ></div>
                  </div>
        ...
        <div className="text-center mt-20">
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#ff9700] to-[#ff9700] text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer">
            ...
            <span className="font-semibold">
              {locale === "pt"
                ? "Seja parte desta história de sucesso"
